...
// add class
  ...
  if ($color == 'red'){
     $box.addClass('red'); //css('background-color','red');
    redCounter++;
    $('#red').find('span').remove();
    $('#red').append('<span>'+ redCounter +'</span>');

  } else if ($color == 'yellow'){
      $box.addClass('yellow');    //css('background-color','yellow');
      yellowCounter++;
      $('#yellow').find('span').remove();
      $('#yellow').append('<span>'+ yellowCounter +'</span>');

  } else if ($color == 'green'){
        $box.addClass('green');   //css('background-color','green');
        greenCounter++;
        $('#green').find('span').remove();
        $('#green').append('<span>'+ greenCounter +'</span>');

  } else if ($color == 'blue'){
          $box.addClass('blue');   //css('background-color','blue');
          blueCounter++;
